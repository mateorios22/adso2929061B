...
<body class="php">
 <nav>
    ...
    <main>
        <header>
            <h1>PHP</h1>
            <img src="../10-php/images/phplogo.png" alt="html">
            &nbsp;
                <p>Is a server-side scripting language primarily used for web development.
                </p>
        </header>
        <menu>
            ...
            <a href="22-form-get.php">
                <span>22</span>
                Form (GET)
            </a>
            <a href="23-form-post.php">
                <span>23</span>
                Form (POST)
            </a>
            ...
            <a href="25-challenges-dates.php">
                <span>25</span>
                Challenges Dates
            </a>
            <a href="26-ssi.php">
